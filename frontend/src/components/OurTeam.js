...
export default function OurTeam() {
  ...
  return (
    ...
    <div className="flex flex-col w-[50%] self-end pt-10 pr-10">
      <h1 className="text-8xl font-bold text-black z-10 HanumanFont border-l-2 border-b-4 border-black pl-[20px] text-nowrap min-w-fit">Meet Our Team</h1>
      <p className="text-2xl font-lighter text-black z-10 pl-[20px]">{aboutTeam}</p>
    </div>  

      <div className="flex flex-row flex-wrap justify-center items-center h-full w-full relative gap-x-[140px]">
